...
const ProductiveUsers = () => {
  ...
  <div class="bg-indigo-100 rounded-lg p-6 text-center shadow-lg my-10  ">
    <h2 class="text-2xl font-bold text-gray-800 mb-4">Joined Thousands of Productive Users</h2>
    <div class="flex justify-center text-center md:justify-around flex-col space-y-7 md:space-y-0 md:flex-row  items-center ">
      <div class="text-center">
       <div className="text-5xl font-bold text-[#059669]"> <CountUp end={90} duration={3}  enableScrollSpy separator="," />K+</div>
        <p class="text-xl mt-5 text-gray-600">Active Users</p>
      </div>
      <div class="text-center">
        <div className="text-5xl font-bold text-[#059669]"> <CountUp end={22} duration={3}  enableScrollSpy separator="," />M+</div>
        <p class="text-xl mt-5 text-gray-600">Total User</p>
      </div>
      <div class="text-center">
        <div className="text-5xl font-bold text-[#059669]"><CountUp end={99} duration={3}  enableScrollSpy separator="," />%</div>
        <p class="text-xl mt-5 text-gray-600">Satisfaction Rate</p>
      </div>
    </div>
  </div>
